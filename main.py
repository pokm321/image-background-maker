...
original_directory = "C:/original/directory/"    # Directory containing images to convert
processed_directory = "C:/processed/directory/"  # Directory to save converted images
